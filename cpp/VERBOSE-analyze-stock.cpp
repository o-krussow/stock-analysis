	...
	if (false) {
		...
		for (float buy_threshold_percent = 0.001; buy_threshold_percent < 2; buy_threshold_percent += 0.00006) {
			for (float sell_threshold_percent = 0.001; sell_threshold_percent < 3; sell_threshold_percent += 0.00006) {
				...
				auto t2 = std::async(run_simulation, price_history, buy_threshold_percent+0.00001, sell_threshold_percent+0.00001, false);
				auto t3 = std::async(run_simulation, price_history, buy_threshold_percent+0.00002, sell_threshold_percent+0.00002, false);
				auto t4 = std::async(run_simulation, price_history, buy_threshold_percent+0.00003, sell_threshold_percent+0.00003, false);
				auto t5 = std::async(run_simulation, price_history, buy_threshold_percent+0.00004, sell_threshold_percent+0.00004, false);
				auto t6 = std::async(run_simulation, price_history, buy_threshold_percent+0.00005, sell_threshold_percent+0.00005, false);
